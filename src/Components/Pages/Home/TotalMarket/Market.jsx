        ...
        <div className="px-4 max-w-6xl mx-auto text-white font-poppins ">
            ...
            <div className="flex flex-col lg:flex-row gap-4 px-4 mt-3 mb-6 justify-between items-center">
                ...
                <div className=" w-full lg:w-2/3 flex flex-col justify-center items-center">
                    ...
                    <a href="https://tonviewer.com/EQBUqHtbPkj-wW2IBZFdhxs_C11LpE4xb8Lc5UY64N2bJ0xI" target="_blank"><img src={marketimg} alt="marketcap" /></a>

                </div>
            </div>
            <div className="flex flex-row gap-2 max-w-4xl mx-auto rounded-2xl justify-center items-centerborder-2 bg-gradient-to-r from-slate-900/50 to-sky-950/70 border-sky-300 ">

                <h1 className="text-xl font-bold text-white text-center">Qumva Network  |</h1>
                <h1 className="text-lg font-bold  text-center">       SYMBOL : QMV </h1>
                <h1 className="text-lg font-bold  text-center">|       NETWORK : Ton </h1>
            </div>
